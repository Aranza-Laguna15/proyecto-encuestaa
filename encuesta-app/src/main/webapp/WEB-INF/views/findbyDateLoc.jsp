...
<form action="findbyDateLoc.htm" method="post">
<div class="form-group">
    <label>De: </label>
    <input type="date" class="form-control" required="required" format="yyyy-MM-dd" name="fec1"/>
    <label>Hasta: </label>
    <input type="date" class="form-control" required="required" format="yyyy-MM-dd" name="fec2"/> 
