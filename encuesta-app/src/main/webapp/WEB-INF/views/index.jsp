...
<button type="submit" class="btn btn-lg btn-info">USERS EDITADOS</button>
</form>
<form action=<c:url value="usersNew.htm"/>>
<button type="submit" class="btn btn-lg btn-info">USERS NUEVOS</button>
</form>
<form action=<c:url value="findbyUser.htm"/>>
<button type="submit" class="btn btn-lg btn-info">FIND BY USER</button>
</form> 
<form action=<c:url value="findbyDate.htm"/>>
<button type="submit" class="btn btn-lg btn-info">FIND BY DATE</button>
</form> 
<form action=<c:url value="findbyDateUser.htm"/>>
<button type="submit" class="btn btn-lg btn-info">FIND BY DATE-USER</button>
</form> 
</div>
